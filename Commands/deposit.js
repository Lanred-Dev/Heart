...
module.exports = {
    ...
    async execute(Message, Message_Args, Client) {
        ...
        if (Amount.toLowerCase() === "all") Amount = Users_Database.Currency[Message.author.id].wallet;
        ...
        if (Amount > Users_Database.Currency[Message.author.id].wallet) return Message.channel.send({embeds: [Bank_Ambulance_Embed(`${Message.author.toString()}, you dont have **${Amount}**:coin: to deposit.`)]});
        ...
        Message.channel.send({embeds: [Deposit_Embed(Amount, Users_Database.Currency[Message.author.id].wallet, Users_Database.Currency[Message.author.id].bank, Message.author.toString())]});
    }
};