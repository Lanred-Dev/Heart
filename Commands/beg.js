...
function Beg_Embed(Status, Person, Footer) {
    const Embed = new Discord.MessageEmbed().setTitle(Person).setDescription(Status).setColor(Global_Embed_Color).setFooter(Footer);
...
module.exports = {
    ...
    async execute(Message, Message_Args, Client) {
        ...
        Global_Databases.Users[Message.author.id].wallet += Money;
