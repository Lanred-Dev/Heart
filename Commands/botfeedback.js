...
const Webhook_Client = new DiscordAPI.WebhookClient({id: process.env.SUGGESTION_LINK_ID, token: process.env.SUGGESTION_LINK_TOKEN});
const Messages = [
    "Thanks for the suggestion/feedback!",
    "Much love ❤, we will take that into consideration.",
