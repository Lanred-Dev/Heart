...
module.exports = {
    info: new SlashCommandBuilder().setName("catfact").setDescription("Those things that always want your attention for some reason."),
    category: "fun",
    cooldown: 5000,
    ...
    async execute(Interaction, Client) {
        ...
        try {
            ...
            Interaction.editReply({ embeds: [Embed(JSON_Response.fact, JSON_Response.image)] });
        } catch (Error) {
